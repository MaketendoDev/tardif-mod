        ...
        switch (part) {
                            ...
                            Text.literal("X: " + data.setPos.x)
                                    ...
                                    .append(
                                            Text.literal(", Y: " + data.setPos.y + ", Z: " + data.setPos.z)
                                                    .formatted(Formatting.AQUA, Formatting.RESET)
                                    ),
                    true
                    );
            ...
            case Y_BUTTON -> {
                if (world.getBlockEntity(pos) instanceof CoordinatesPanelBlockEntity panelBlock) {
                    ...
                    player.sendMessage(
                            Text.literal("X: " + data.setPos.x + ", ")
                                    .formatted(Formatting.AQUA).append(Text.literal("Y: " + data.setPos.y).formatted(Formatting.AQUA, Formatting.BOLD)).append(Text.literal(", Z: " + data.setPos.y).formatted(Formatting.AQUA)),
                            true
                    );
                ...
                if (world.getBlockEntity(pos) instanceof CoordinatesPanelBlockEntity panelBlock) {
                    ...
                    player.sendMessage(
                            Text.literal("X: " + data.setPos.x + ", Y: " + data.setPos.y + ", ")
                                    .formatted(Formatting.AQUA).append(Text.literal("Z: " + data.setPos.y).formatted(Formatting.BOLD, Formatting.AQUA)),
                            true
                    );
